...
router.get("/notifications", middleware.isLoggedIn, userController.userNotificationsIndexGet);

// handle notification on click
router.get("/notifications/:id", middleware.isLoggedIn, userController.userNotificationsGet);

// Show request password reset page
router.get("/forgot", userController.userForgotGet);

// Send password reset email
router.post("/forgot", userController.userForgotPost);
