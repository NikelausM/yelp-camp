...
class CampgroundController {
	...
	static async setCampgroundLocData(req) {
		try {
	...
	static async campgroundCreatePost(req, res) {
		...
		try {
			...
			await CampgroundController.setCampgroundLocData(req)
	...
	static async campgroundUpdatePut(req, res) {
		try {
			let campground = await CampgroundController.setCampgroundLocData(req);
