...
* @requires errors
* @requires api-helper
* @requires geocoder-helper
* @requires cloudinary-helper
* @requires general-helper
* @requires user
* @requires campground
* @requires comment
...
class CampgroundController {
	...
	* @param {module:Campground} campground - The Campground object.
	* @return {module:Campground} The modified campground.
	*/
	...
	* @param {module:Campground} campground - The modified campground.
	*/
